...
import imgMan from '../assets/man/Kisore 1.png';
...
const MISSIONS = [
  {
    id: '01',
    name: 'LinkCraft ',
    description: 'Developed a professional networking platform that allows users to create profiles, share posts, and connect with other users through an interactive and user-friendly system. The platform provides secure user access and a responsive experience while ensuring smooth communication and efficient data management.',
    tech: ['React', 'WebSockets', 'Express.js', 'MySQL'],
    image: imgSpiderman,
    link: '#',
  ...
  },
  {
    ...
    description: 'Developed a vehicle rental platform that allows users to book vehicles easily with flexible pricing based on rental duration such as hourly, daily, or weekly plans. The system provides a smooth and secure booking experience with efficient vehicle management and a responsive user interface for better user interaction.',
    tech: ['Java', 'Spring Boot', 'MySQL', 'JavaScript'],
    image: imgMan,
    link: 'https://vehicleonlin.netlify.app/landing.html',
    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden bg-zinc-900">
        <img 
          ...
          src={project.image} 
          alt={project.name} 
          className={`absolute inset-0 w-full h-full object-cover object-center ${project.blend} transition-all duration-[1.5s]`}
        />
