        ...
        <div ref={textContainerRef} className="flex flex-col justify-center space-y-10">
          ...
          <div className="overflow-hidden">
            <h2 className="stagger-reveal text-5xl md:text-6xl font-bold tracking-tighter text-white font-sans leading-tight">
             Java Developer | Spring Boot | REST APIs <br />
          ...
          <div className="overflow-hidden">
            <p className="stagger-reveal text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-xl">
              B.Tech IT graduate with strong skills in Core Java, OOP, and Data Structures. Experienced in building RESTful APIs using Spring Boot, with knowledge of MySQL, JDBC, and Git. Passionate about developing scalable applications and growing as a full-stack developer. Actively seeking opportunities to contribute and learn in a real-world development environment.
            </p>
          </div>
